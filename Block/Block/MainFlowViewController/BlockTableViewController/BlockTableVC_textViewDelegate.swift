...
extension BlockTableViewController: UITextViewDelegate {
    ...
    func textViewDidEndEditing(_ textView: UITextView) {
        ...
        detect(data: textView.text, using: block)
    ...
    func textView(_ textView: UITextView, shouldInteractWith URL: URL, in characterRange: NSRange, interaction: UITextItemInteraction) -> Bool {
        return interact(textView, url: URL, range: characterRange)
    }
    ...
    internal func moveCellIfNeeded(_ textView: UITextView, shouldChangeTextIn range: NSRange, replacementText text: String) -> Bool {
        ...
        case .moveNext:
            ...
            detect(data: frontText, using: block)
...
extension BlockTableViewController: Detection, CNContactViewControllerDelegate, EKEventEditViewDelegate {
